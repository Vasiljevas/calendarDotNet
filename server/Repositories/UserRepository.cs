...
namespace CalendarApi.Repositories
{
  public class UserRepository : IUserRepository
  {
    ...
    {
      return _context.Users.Include(u => u.Events).Include(u => u.Invitations).ToList().First(u => u.Id == id);
    }
    ...
    {
      var user = _context.Users.Include(u => u.Events).Include(u => u.Invitations).ToList().First(u => u.Id == id);
      return user.Events;
    }
